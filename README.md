...
🌐 Portfolio: https://thirdytapawan.vercel.app/
...
- **Full-Stack Web** — Next.js, TypeScript, and React — fast, accessible interfaces that ships 
...
- 📡 **[HELIX 7](https://github.com/ThirdyTapawan/helix7-demo)** — Terminal-based interactive fiction where your typing accuracy steers the story ([play it](https://thirdytapawan.github.io/helix7-demo/))
...
- 📈 **Credit Risk Dashboard** — Power BI + star-schema model tracking aging, exposure, and delinquency

### 🛠️ Toolkit
TypeScript, Python, Next.js, React, Tailwind CSS, n8n, UiPath, Power BI, SQL
